      ...
      <div className="filters-bar">
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 6 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            {showColMenu && (
              <div style={{ position: 'absolute', right: 0, top: '110%', background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 10, padding: 10, zIndex: 50, minWidth: 140, boxShadow: 'var(--shadow2)', display: 'flex', flexDirection: 'column', gap: 6 }}>
                {ALL_COLS.map(col => (
